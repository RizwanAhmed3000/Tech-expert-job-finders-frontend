...
//       <div className='bg-theme-red w-[50%] p-8 rounded-lg'>
//         <p className='text-xl text-white'>AI Assistance</p>
//         <p className='text-xl text-white'>Ask AI Assistance Question about Career, Jobs, Business and Finance</p>
//         <button className='bg-white text-theme-red p-2 text-xl mt-2 rounded-lg font-semibold'>AI Assistance</button>
//       </div>
...
//             <button className='bg-white shadow-lg text-theme-red p-2 text-xl rounded-lg font-semibold'>Upload Photo</button>
//             <button className='bg-white shadow-lg flex text-theme-red p-2 text-xl rounded-lg font-semibold'><span>Ask Question</span><GoReply className='text-2xl'/></button>
//           </div>
//         </div>
//         <iframe
//           width="100%"
...
const DashQuestion = () => {
  ...
  return (
    <div className='p-[4rem] w-full flex'>
        <div className='w-[50%]'>
      ...
      {isModalOpen && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center'>
          <div className='bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-[600px] relative'>
            ...
            <h2 className='text-center text-2xl font-semibold mb-4 text-theme-red'>Ask Question?</h2>
            <textarea
            ...
            <div className='flex justify-between'>
              ...
              <span>Ask Question</span><GoReply className='text-2xl'/>
              </button>
            </div>
