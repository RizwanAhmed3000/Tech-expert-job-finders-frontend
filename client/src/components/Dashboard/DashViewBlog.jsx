...
// const DashViewBlog = ({openModal , closeModal , template}) => {
...
//                 <div className="wrapper px-[2.2rem] py-[1rem] flex flex-col ">
//                     <div className="upper flex gap-[2rem]">
//                         <div className="left">
//                             <div className="imgContainer w-[100%]  border-[1px] rounded-[7px] p-[1rem]">
    ...
    return (
        <div className="fixed z-[100] h-[100%] inset-0 bg-black bg-opacity-50 flex justify-center items-center overflow-y-scroll py-[30px]">
            <div className="bg-white p-6 rounded-lg shadow-lg w-[700px] max-w-[60%] relative my-auto">
                ...
                <hr className='border-[#c6c2c2] border-[1.2px]' />
                <div className="wrapper px-[2.2rem] py-[1rem] flex flex-col items-center">
                    <div className="imgContainer w-full border-[1px] rounded-[7px] p-[1rem] mb-6">
                        <img src={template.imgUrl} alt="Template" className='w-full h-auto' />
                    </div>
                 
                  
                   
                    <div className="lower relative w-full">
