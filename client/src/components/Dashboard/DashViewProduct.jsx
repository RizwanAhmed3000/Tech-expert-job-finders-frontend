                ...
                <div className="wrapper px-[2.2rem] py-[1rem] flex flex-col gap-[3rem]">
                    <div className="upper flex gap-[2rem]">
                        <div className="left">
                            <div className="imgContainer w-[290px] h-[432.32px] border-[1px] rounded-[7px] p-[1rem]">
                                <img src={cvImg1} alt="" className='w-[100%] h-[100%]' />
                            </div>
                        </div>
                        <div className="right flex flex-col gap-5">
                            <h1 className=' font-bold text-[2.4rem]'>Template Name</h1>
                            <h1 className="price text-theme-red font-bold text-[1.6rem]">$ 5</h1>
                            <p className='text-[1.4rem] leading-[1.68rem] font-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora et quidem necessitatibus laudantium eaque culpa tempore voluptatum quisquam ipsum minima vero odio hic, molestiae blanditiis. Quisquam est qui recusandae sequi.</p>
                            ...
                            <p className='text-[1.3rem]'>Two easy way to pay</p>
                    ...
                    <div className="lower relative">
                        ...
                        <div className="mainBox border-[1px] border-t-0 p-[2rem] flex flex-col gap-3">
                            <p className='text-[1.3rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, consequuntur ullam in dolorum, sit perferendis ducimus voluptatem fugiat exercitationem corrupti itaque ad enim, tempora vel blanditiis nulla mollitia. Assumenda, officia.</p>
