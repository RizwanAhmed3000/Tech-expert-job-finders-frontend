  ...
  return (
    <div className=" flex justify-center items-center mt-5">
          <div className="bg-white w-full  ">
            ...
            <span
        className={`text-lg px-4 py-2  cursor-pointer ${getTabClassNames('free')}`}
        onClick={() => handleTabClick('free')}
      >
        Free
      </span>
      <span
        className={`text-lg px-4 py-2  cursor-pointer ${getTabClassNames('premium')}`}
        onClick={() => handleTabClick('premium')}
      >
        Premium 
      </span>
      <span
        className={`text-lg px-4 py-2  cursor-pointer ${getTabClassNames('my')}`}
      ...
      >
        My Template
            ...
            <div className=" w-full "><input type="search" placeholder="Search"  className="border w-full p-4 rounded-lg" name="" id="" /></div>
