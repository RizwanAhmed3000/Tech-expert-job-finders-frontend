  ...
  return (
    <div className='w-full bg-white flex justify-center mt-10'>
        <div className='w-2/4 bg-coral-light text-center m-5 p-10 rounded-lg'>
            <h1 className='text-5xl text-theme-red font-bold'>Get ahead of the competition</h1>
            <p className='m-5 text-xl'>Make your job applications stand-out from other candidates</p>
