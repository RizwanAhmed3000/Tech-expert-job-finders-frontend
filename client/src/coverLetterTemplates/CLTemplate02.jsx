        ...
        <div className="flex flex-row mt-16 text-[17px]">
          <div>
            ...
            <div className="mt-[320px] text-2xl text-pink-700">
              ...
              <p className="ml-8 mb-3">
                <i class="ri-mail-line mr-2 text-pink-900"></i>email
              </p>
              <p className="ml-8 mb-3">
                <i class="ri-global-line mr-2 text-pink-900"></i>website
              </p>
              <p className="ml-8 mb-3">
                <i class="ri-phone-line mr-2 text-pink-900"></i>phone
              </p>
            </div>
          </div>
          ...
          <div className=" w-[100%] h-[100vh] ml-40">
            ...
            <h3 className="text-3xl font-normal text-pink-700">
              Dear Recipient Name
            </h3>
            <p className="mt-9">
              Recipient Street Address Recipient City, ST Zip If you're ready to
              write, select a line or paragraph of tip text and start typing to
              replace it with your own. Don't include space to the right of the
              characters in your selection. <br />
            </p>

            <p className="mt-7">
              {" "}
              It's easy to match any of the text formatting you see here. On the
              Home tab of the ribbon, check out the Styles gallery for all
              styles used in this letter.
            </p>
