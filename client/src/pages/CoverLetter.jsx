      ...
      <div className="coverLetterCont flex flex-col px-[4%]">
        ...
        <div className="w-full flex flex-col items-center gap-[0.5rem] mt-[8rem] py-[5rem]">
          ...
          <p className="text-[1.5rem] font-medium text-center">
            View our list of Cover Letter templates for every profession and
            career.
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-4 gap-[4rem] pb-[8rem]">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((item, index) => (
            <figure className="singleCoverLetterCont flex flex-col shadow-2xl group/tmpCard ">
              <div className="coverLetterImage">
                <img src={coverLetterTemplate} alt="CoverLetterTemplate" />
              </div>

              <figcaption className="coverLetterContent relative z-10 px-[2rem] py-[2.5rem]">
                ...
                <a
                  href="#"
                  className="flex items-center gap-[0.5rem] absolute -z-10 bottom-[2rem] left-[2rem] text-[1.5rem] opacity-0 group-hover/tmpCard:opacity-100 transition-all duration-500 text-theme-red font-medium"
                >
