                    ...
                    <div className='w-[631px] flex flex-col justify-center items-center'>
                        <div>
                            ...
                            <p className='text-[1.4rem] leading-relaxed'>
                                At my CV Creator CV/Resume writing services, our team of expert CV/Resume writers are second to none.
                                <br />
                                We are expreienced HR specialist and career coaches so we understand what you are going through.
                                <br />
                                We have in-depth knowledge and vast experience creating professional CV's/Resume's and cover letters for clients of various backgrounds and industries.
                                Many of us are M.Sc. and MBA holders from reputable Universities. So we are highly qualified to handle your CV/Resume writing.
                            </p>
                        </div>
                            ...
                            <div className='my-[1.2rem]'>
                                ...
                                <div class="mt-2 ">
                                    <textarea
                                        ...
                                        placeholder='Special Note'rows={7}
                                    />
                                </div>
                            </div>
